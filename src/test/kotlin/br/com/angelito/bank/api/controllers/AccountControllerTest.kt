...
class AccountControllerTest {
    ...
    @Test
    fun `test find all`() {
        accountRepository.save(AccountModel(name = "Test", document = "123", phone = "987654321"))
    ...
    @Test
    fun `test find by id`() {
        val account = accountRepository.save(AccountModel(name = "Test", document = "123", phone = "987654321"))
    ...
    fun `test create account`() {
        val account = AccountModel(name = "Test Create", document = "123", phone = "987654321")
    ...
    fun `test update account`() {
        val account = accountRepository
            .save(AccountModel(name = "Test", document = "123", phone = "987654321"))
            .copy(name = "Updated")
        val json = ObjectMapper().writeValueAsString(account)
    ...
    fun `test create account validation error empty name`() {
        val account = AccountModel(name = "", document = "123", phone = "987654321")
        val json = ObjectMapper().writeValueAsString(account)
        accountRepository.deleteAll()
    ...
    fun `test create account validation error name should be 5 character`() {
        val account = AccountModel(name = "test", document = "123", phone = "987654321")
        val json = ObjectMapper().writeValueAsString(account)
        accountRepository.deleteAll()
